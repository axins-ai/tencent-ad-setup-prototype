  ...
  function App() {
    ...
    const doSaveAsTgtPkg = () => {
      ...
      const pkg = {
        ...
        age: ageSelection === 'unlimited' ? '不限' : ageSelection === 'custom' ? ageMin + '-' + ageMax : ageSelection,
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      onChange: e => {
        let next = ageSelections.filter(k => k !== 'unlimited');
        if (e.target.checked && !next.includes('custom')) next.push('custom');else next = next.filter(k => k !== 'custom');
        setAgeSelections(next.length > 0 ? next : ['unlimited']);
      },
      disabled: ageSelections.includes('unlimited'),
      className: "mr-1.5"
    }), /*#__PURE__*/React.createElement("span", {
      className: `text-sm ${ageSelections.includes('custom') ? 'text-gray-900 font-medium' : ageSelections.includes('unlimited') ? 'text-gray-300' : 'text-gray-700'}`
    }, "自定义"), /*#__PURE__*/React.createElement("i", {
      className: "fas fa-info-circle text-gray-300 ml-1 text-xs cursor-help",
      title: "自定义年龄段"
    })))), ageSelections.includes('custom') && /*#__PURE__*/React.createElement("div", {
      className: "ml-[52px] flex items-center gap-3 animate-fadeIn"
    }, /*#__PURE__*/React.createElement("input", {
      type: "number",
      value: customAgeMin,
    ...
    }, "岁"))), /*#__PURE__*/React.createElement("div", {
      className: "py-4 border-b border-gray-200"
    }, /*#__PURE__*/React.createElement("div", {
