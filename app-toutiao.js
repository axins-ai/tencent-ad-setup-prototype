...
function App() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "flex items-center cursor-pointer px-4 py-2 border rounded-lg text-sm",
    style: {
      borderColor: marketingScene === 'short_video' ? '#1890ff' : '#e5e7eb',
      background: marketingScene === 'short_video' ? '#eff6ff' : '#fff'
    }
  }, /*#__PURE__*/React.createElement("input", {
    type: "radio",
    name: "marketingScene",
    value: "short_video",
    checked: marketingScene === 'short_video',
    onChange: () => setMarketingScene('short_video'),
    className: "w-4 h-4 mr-2 text-blue-600"
  }), /*#__PURE__*/React.createElement("span", null, "短视频")), /*#__PURE__*/React.createElement("label", {
    className: "flex items-center cursor-pointer px-4 py-2 border rounded-lg text-sm",
    style: {
      borderColor: marketingScene === 'image_text' ? '#1890ff' : '#e5e7eb',
      background: marketingScene === 'image_text' ? '#eff6ff' : '#fff'
    }
  }, /*#__PURE__*/React.createElement("input", {
    type: "radio",
    name: "marketingScene",
    value: "image_text",
    checked: marketingScene === 'image_text',
    onChange: () => setMarketingScene('image_text'),
    className: "w-4 h-4 mr-2 text-blue-600"
  }), /*#__PURE__*/React.createElement("span", null, "图文")))), /*#__PURE__*/React.createElement("div", {
    className: "flex items-center gap-3 mb-5"
  }, /*#__PURE__*/React.createElement("label", {
    className: "w-28 text-left text-sm font-medium text-gray-700 flex-shrink-0"
    ...
    value: productAllocMode,
    onChange: e => setProductAllocMode(e.target.value),
    className: "w-40 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
  }, /*#__PURE__*/React.createElement("option", {
    value: "shared"
  }, "全账户共用"), /*#__PURE__*/React.createElement("option", {
    value: "per_account"
  }, "分账户定制")), productAllocMode === 'shared' ? /*#__PURE__*/React.createElement("select", {
  ...
  }, "投放将从今天开始，长期有效")))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "block text-sm font-medium text-gray-700 mb-1"
    ...
    className: "text-sm font-bold text-gray-900 mb-3"
  }, "创意组件"), /*#__PURE__*/React.createElement("label", {
    className: "flex items-center cursor-pointer px-4 py-2 border rounded-lg text-sm",
    style: {
      borderColor: 'additional' === 'additional' ? '#1890ff' : '#e5e7eb'
    }
  }, /*#__PURE__*/React.createElement("input", {
    type: "checkbox",
    checked: true,
    readOnly: true,
    className: "w-4 h-4 mr-2 text-blue-600"
  }), /*#__PURE__*/React.createElement("span", null, "附加创意组件")), /*#__PURE__*/React.createElement("div", {
    className: "mt-3 pl-6"
  }, /*#__PURE__*/React.createElement("label", {
    className: "flex items-center cursor-pointer"
  }, /*#__PURE__*/React.createElement("input", {
  ...
  }, "智能生成（默认开启）")))), /*#__PURE__*/React.createElement("div", {
    className: "border-t pt-4"
  }, /*#__PURE__*/React.createElement("h4", {
