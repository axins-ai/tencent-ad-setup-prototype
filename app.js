...
function App() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    key: conv.id,
    value: conv.id
  }, conv.name)))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "w-4 h-4 mr-2 text-blue-600"
  }), /*#__PURE__*/React.createElement("span", null, "微信公众号与小程序")))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "block text-sm font-medium text-gray-700 mb-2"
  }, "版位定投场景"), /*#__PURE__*/React.createElement("button", {
  ...
  }, "广告将在投放首日该时间开始投放"))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "block text-sm font-medium text-gray-700 mb-1"
  ...
  }, placement === 'wechat_video' ? '视频号固定为1' : '范围 1~15')), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "text-xs text-gray-500 mb-1"
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      const configItems = (() => {
        ...
        items.push({
          label: '品牌形象',
          value: brandImageType === 'video_account' ? selectedVideoAccount ? selectedVideoAccount.name : '未选择视频号' : selectedBrandImage ? selectedBrandImage.name : '未选择',
          required: false,
          ok: brandImageType === 'video_account' ? !!selectedVideoAccount : !!selectedBrandImage
        });
        items.push({
          label: '营销组件',
          value: marketingComponentType === 'action_button' ? '行动按钮（' + actionButtonType + '）' : selectedComponent ? selectedComponent.btnText : '未选择',
          required: false,
          ok: marketingComponentType === 'action_button' ? !!actionButtonType : !!selectedComponent
        });
        items.push({
          label: '创意名称',
        ...
        items.push({
          label: '搭建类型',
          value: buildType === 'creative_only' ? '仅搭建创意' : '搭建单元+创意',
          required: false,
          ok: true
        });
        items.push({
          label: '一键起量',
          value: quickLaunch ? quickLaunchBudget !== '' ? '已开启（¥' + quickLaunchBudget + '）' : '已开启（未填预算）' : '未开启',
          required: false,
          ok: !quickLaunch || quickLaunchBudget !== ''
        });
        if (quickLaunch) items.push({
          label: '起量预算',
          value: quickLaunchBudget !== '' ? '¥' + quickLaunchBudget : '未设置',
          required: true,
          ok: quickLaunchBudget !== ''
        });
        items.push({
          label: '推官链接',
